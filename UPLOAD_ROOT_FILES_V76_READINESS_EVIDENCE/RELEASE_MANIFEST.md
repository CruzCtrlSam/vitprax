...
Release: Vitprax Practice V7.6 Readiness Evidence Model
...
No Supabase schema change is required for V7.6. Texas Life can still load protected questions and flashcards from the existing Supabase tables. CIT currently uses the bundled starter architecture and original sample content until a certification-aware protected content table is added in a later phase.

## Stripe

No Stripe product or webhook update is required for V7.6.
...
- Cache tags are updated to `7.6-readiness-evidence`.
