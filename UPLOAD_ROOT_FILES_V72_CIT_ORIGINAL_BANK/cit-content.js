  ...
  const expansionQuestions = [
    ...
    q(
      ...
      [
        ...
        { id: "cit-d2-original-q003-b", text: "Course marketing" },
        { id: "cit-d2-original-q003-c", text: "Summative evaluation" },
        { id: "cit-d2-original-q003-d", text: "Classroom management" }
      ],
      ...
      {
        "cit-d2-original-q003-b": "Marketing promotes a course; it does not analyze job tasks.",
        "cit-d2-original-q003-c": "Summative evaluation judges effectiveness after delivery.",
        "cit-d2-original-q003-d": "Classroom management deals with the learning environment during instruction."
      },
    ...
    q(
      ...
      [
        ...
        { id: "cit-d2-original-q005-b", text: "Post-course celebration" },
        { id: "cit-d2-original-q005-c", text: "Learner entertainment planning" },
        { id: "cit-d2-original-q005-d", text: "Logo design" }
      ],
      ...
      {
        "cit-d2-original-q005-b": "Celebration does not identify training requirements.",
        "cit-d2-original-q005-c": "Engagement matters, but entertainment is not the source of regulatory need.",
        "cit-d2-original-q005-d": "Branding does not define required training content."
      },
    ...
    q(
      ...
      [
        ...
        { id: "cit-d3-original-q002-b", text: "Remember only" },
        { id: "cit-d3-original-q002-c", text: "React" },
        { id: "cit-d3-original-q002-d", text: "Attend" }
      ],
      ...
      {
        "cit-d3-original-q002-b": "Remembering facts alone does not require inspecting and interpreting conditions.",
        "cit-d3-original-q002-c": "Reaction is an evaluation category, not a Bloom cognitive level for this objective.",
        "cit-d3-original-q002-d": "Attendance or attention is not the performance described in the objective."
      },
    ...
    q(
      ...
      [
        ...
        { id: "cit-d3-original-q003-b", text: "Learner reaction item" },
        { id: "cit-d3-original-q003-c", text: "Room arrangement" },
        { id: "cit-d3-original-q003-d", text: "Attendance policy" }
      ],
      ...
      {
        "cit-d3-original-q003-b": "A reaction item asks how learners felt about training.",
        "cit-d3-original-q003-c": "Room arrangement supports delivery but is not a learning outcome.",
        "cit-d3-original-q003-d": "Attendance policy controls participation, not terminal performance."
      },
    ...
    q(
      ...
      [
        ...
        { id: "cit-d3-original-q004-b", text: "A lecture with no practice" },
        { id: "cit-d3-original-q004-c", text: "A satisfaction survey before instruction" },
        { id: "cit-d3-original-q004-d", text: "A poster placed near the classroom door only" }
      ],
      ...
      {
        "cit-d3-original-q004-b": "Lecture can introduce information but cannot verify hands-on performance alone.",
        "cit-d3-original-q004-c": "A survey measures reaction or opinion, not skill development.",
        "cit-d3-original-q004-d": "A poster may support recall but is not enough for a performance objective."
      },
    ...
    q(
      ...
      [
        ...
        { id: "cit-d3-original-q005-b", text: "Understand fall protection" },
        { id: "cit-d3-original-q005-c", text: "Know safety better" },
        { id: "cit-d3-original-q005-d", text: "Enjoy the fall protection course" }
      ],
      ...
      {
        "cit-d3-original-q005-b": "Understand is hard to observe unless a measurable behavior is added.",
        "cit-d3-original-q005-c": "Know is too vague to assess directly.",
        "cit-d3-original-q005-d": "Enjoyment is a reaction outcome, not a competency objective."
      },
    ...
    q(
      ...
      [
        ...
        { id: "cit-d4-original-q002-b", text: "A sign-in sheet only" },
        { id: "cit-d4-original-q002-c", text: "A course advertisement" },
        { id: "cit-d4-original-q002-d", text: "A learner lunch menu" }
      ],
      ...
      {
        "cit-d4-original-q002-b": "A sign-in sheet documents attendance but does not guide instruction.",
        "cit-d4-original-q002-c": "An advertisement promotes the course, not delivery consistency.",
        "cit-d4-original-q002-d": "A menu has no instructional control function."
      },
    ...
    q(
      ...
      [
        ...
        { id: "cit-d4-original-q003-d", text: "Course cancellation notice" }
      ],
      ...
      "A job aid supports correct performance at the point of work. It is especially useful when workers must follow a sequence, verify critical steps, or reduce memory load.",
      {
        ...
        "cit-d4-original-q003-d": "A cancellation notice is administrative, not instructional support."
      },
    ...
    q(
      ...
      [
        ...
        { id: "cit-d4-original-q004-d", text: "Use the SME only to approve the room layout" }
      ],
      ...
      "SMEs are valuable for technical accuracy, current practice, and real workplace examples. The trainer still translates that expertise into objectives, activities, materials, and assessment methods.",
      {
        ...
        "cit-d4-original-q004-d": "Room layout is not the SME's main value in course development."
      },
    ...
    q(
      ...
      [
        ...
        { id: "cit-d5-original-q002-b", text: "Writing terminal objectives" },
        { id: "cit-d5-original-q002-c", text: "Calculating Level 4 results" },
        { id: "cit-d5-original-q002-d", text: "Replacing the needs assessment" }
      ],
      ...
      {
        "cit-d5-original-q002-b": "Objectives should already be designed before delivery.",
        "cit-d5-original-q002-c": "Level 4 results are evaluated after training through organizational outcomes.",
        "cit-d5-original-q002-d": "Environment setup does not replace determining the training need."
      },
    ...
    q(
      ...
      [
        ...
        { id: "cit-d5-original-q003-b", text: "Cancel the course without checking alternatives" },
        { id: "cit-d5-original-q003-c", text: "Blame learners for not logging in earlier" },
        { id: "cit-d5-original-q003-d", text: "Skip all interactive portions permanently" }
      ],
      ...
      {
        "cit-d5-original-q003-b": "Cancellation may be necessary later, but the first step is to assess and use available alternatives.",
        "cit-d5-original-q003-c": "Blame does not solve the delivery problem.",
        "cit-d5-original-q003-d": "Removing interactivity may weaken learning and should not be the automatic response."
      },
    ...
    q(
      ...
      [
        ...
        { id: "cit-d5-original-q005-b", text: "Read the slides louder" },
        { id: "cit-d5-original-q005-c", text: "Remove the learning objectives" },
        { id: "cit-d5-original-q005-d", text: "Tell learners their experience does not matter" }
      ],
      ...
      {
        "cit-d5-original-q005-b": "Volume does not fix a relevance problem.",
        "cit-d5-original-q005-c": "Objectives are still needed to guide instruction and assessment.",
        "cit-d5-original-q005-d": "Dismissing experience undermines adult learning principles."
      },
    ...
    q(
      ...
      [
        ...
        { id: "cit-d6-original-q002-b", text: "Physical ability to operate a rescue tripod" },
        { id: "cit-d6-original-q002-c", text: "Whether learners enjoyed lunch" },
        { id: "cit-d6-original-q002-d", text: "The exact room temperature during class" }
      ],
      ...
      {
        "cit-d6-original-q002-b": "A hands-on performance assessment is needed to verify physical operation.",
        "cit-d6-original-q002-c": "Enjoyment is a reaction measure.",
        "cit-d6-original-q002-d": "Room temperature may affect comfort but is not the learner competency."
      },
    ...
    q(
      ...
      [
        ...
        { id: "cit-d6-original-q003-b", text: "The course logo" },
        { id: "cit-d6-original-q003-c", text: "The number of coffee breaks" },
        { id: "cit-d6-original-q003-d", text: "The learner reaction survey only" }
      ],
      ...
      {
        "cit-d6-original-q003-b": "Branding does not control scoring consistency.",
        "cit-d6-original-q003-c": "Breaks may affect comfort but not scoring criteria.",
        "cit-d6-original-q003-d": "Reaction surveys do not define performance standards."
      },
    ...
    q(
      ...
      [
        ...
        { id: "cit-d6-original-q005-b", text: "A vague note saying the class went well" },
        { id: "cit-d6-original-q005-c", text: "A photo of the classroom" },
        { id: "cit-d6-original-q005-d", text: "A copy of the lunch receipt" }
      ],
      ...
      {
        "cit-d6-original-q005-b": "A vague note does not show the skill standard or result.",
        "cit-d6-original-q005-c": "A classroom photo does not prove individual competency.",
        "cit-d6-original-q005-d": "A receipt is unrelated to training performance."
      },
