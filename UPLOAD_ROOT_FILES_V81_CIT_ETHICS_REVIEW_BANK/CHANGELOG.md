...
## V8.1 - CIT Ethics and Review Usability

- Expanded the supplemental CIT ethics/professional-conduct set from 4 to 10 original questions.
- Added higher-pressure judgment scenarios around incomplete competency evidence, evaluator consistency, operational pressure, language equity, data privacy, and training-record integrity.
- Preserved the 100 weighted-domain CIT exam format while increasing the full practice bank to 110 questions.
- Regenerated the reviewer file with usage guidance, a domain map, and a compact answer-key section.

## V8.0 - CIT Official-Format Bank

- Expanded the bundled BCSP CIT practice bank to 104 original Vitprax questions, including 100 weighted-domain questions plus supplemental ethics/professional-conduct practice.
- Used the provided domain-weight outline as a coverage guide while keeping the new questions, distractors, and explanations original.
- Updated CIT metadata so the track clearly shows practice-bank size and the 100-question official-style exam format.
- Improved CIT question metadata so scenario, application, BEST, MOST, and FIRST-action items are classified more accurately in stats.

## V7.9 - CIT English-First Practice

- Made CIT quiz and exam question text English-first to better match exam conditions.
- Kept Spanish mode available for navigation, study support, flashcards, and bilingual review context.
- Added a Spanish-mode setup note explaining why CIT practice questions remain in English.
- Hardened explanation rendering so partial Spanish CIT content safely uses the English exam wording.
- Updated cache tags so Safari and GitHub Pages load the CIT language-policy update.
