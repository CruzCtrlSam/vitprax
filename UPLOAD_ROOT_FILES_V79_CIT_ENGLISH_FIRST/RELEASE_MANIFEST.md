...
Release: Vitprax Practice V7.9 CIT English-First Practice
...
No Supabase schema change is required for V7.9. Texas Life can still load protected questions and flashcards from the existing Supabase tables. CIT currently uses the bundled 60-question original bank until a certification-aware protected content table is added in a later phase.

## Stripe

No Stripe product or webhook update is required for V7.9.
...
- CIT now includes 60 original bundled questions across the weighted domains plus supplemental ethics.
- CIT practice and exam questions now stay English-first while Spanish mode supports navigation, study, and review.
- Cache tags are updated to `7.9-cit-english-first`.
