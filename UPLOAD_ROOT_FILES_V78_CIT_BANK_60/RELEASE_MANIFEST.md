...
Release: Vitprax Practice V7.8 CIT 60-Question Original Bank
...
No Supabase schema change is required for V7.8. Texas Life can still load protected questions and flashcards from the existing Supabase tables. CIT currently uses the bundled 60-question original bank until a certification-aware protected content table is added in a later phase.

## Stripe

No Stripe product or webhook update is required for V7.8.
...
- Cache tags are updated to `7.8-cit-bank-60`.
